...
void metropolis_simulation(int lattice[size_x][size_y], int neighbors[size_x][size_y][num_nn], double J, double min_T, double max_T, int num_T, string filename) {
    ...
    for (int i = 0; i < num_T; i++) {
        ...
        acceptance[i] = (double) num_accepted / num_calls;
    }
...
int main(int argc, char* argv[]) {
    ...
    metropolis_simulation(lattice, neighbors, 1, T_low, T_high, n_T, filename); 
}
